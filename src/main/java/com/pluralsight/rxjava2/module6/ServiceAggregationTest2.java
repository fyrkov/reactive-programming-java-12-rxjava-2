    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            try(NitriteTestDatabase testDatabase = new NitriteTestDatabase(Optional.of(schema))) {
                ...
                // concatArrayEager DOES execute observables concurrently!  But be careful.
                // concatArrayEager subscribes to ALL incoming Observables at the
                // same time, so going too crazy with it could overrun a Scheduler.
